...
export default function Sidebar_Dropdown() {
    ...
    return (
        <div className="flex flex-col" style={{ borderColor: "var(--bordercolor)" }}>
            {/* Dropdown Button */}
            <button
                onClick={toggleDropdown}
                className="flex items-center justify-between gap-[2vh] text-[1.25vw] rounded-2xl px-[1vw] py-[0.75vh] hover:bg-[#A76D3E] transition w-full"
            >
                RESOURCES
