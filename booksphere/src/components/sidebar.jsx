...
export default function Sidebar() {
    ...
    return (
        ...
        <div className="flex flex-col justify-between gap-[4vh] h-full p-[1vw] border-x-1 border-t-1" style={{ backgroundColor: "var(--bgcolordark)", borderColor: "var(--bordercolor)", color: "var(--headingcolordark)" }}>
